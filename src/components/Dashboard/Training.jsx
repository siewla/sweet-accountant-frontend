                    ...
                    <div class="row">
                        ...
                        <div class="col-md-7 mb-lg-0 mb-4">
                            <form onSubmit={handleSubmit} encType="multipart/form-data">
                                    ...
                                    <div class="modal-dialog modal-notify modal-info" role="document">
                                        ...
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-header">
                                                <p class="heading lead">Format CSV File</p>
                                            ...
                                            <div class="modal-body">
                                                ...
                                                <section>
                                                    ...
                                                    <h3 class="font-weight-bold text-center dark-grey-text pb-2">Two Easy Steps</h3>
                                                    <hr class="w-header my-4" />
                                                    <p class="lead text-center text-muted pt-2 mb-5">Sample data</p>

                                                    <div class="row align-items-center">

                                                        <div class="">
                                                            <div class="view z-depth-1-half rounded">
                                                                <img class="rounded img-fluid" src="https://res.cloudinary.com/dt5rqi1l9/image/upload/v1599627044/Screen_Shot_2020-09-09_at_12.46.01_PM_f4nfcd.png" alt="Video title" />
                                                        ...
                                                        <div class="">
                                                            ...
                                                            <ol class="step pl-0">
                                                                <li class="step-element pb-0">
                                                                    ...
                                                                    <div class="step-excerpt">
                                                                        <h6 class="font-weight-bold dark-grey-text mb-3">Create</h6>
                                                                        <p class="text-muted">Create your data, make sure it has 2 columns: description and category. Categories have to be followed this
                                                                ...
                                                                <li class="step-element pb-0">
                                                                    ...
                                                                    <div class="step-excerpt">
                                                                        <h6 class="font-weight-bold dark-grey-text mb-3">Save / Export</h6>
                                                                        <p class="text-muted">Save and export it as csv file</p>
                                                                    </div>
                                                                </li>
                                                            </ol>
                                                            {/* <!-- Central Modal Medium Info --> */}
                                                            <div class="modal fade" id="centralModalInfo-1" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"
                                                                ...
                                                                <div class="modal-dialog modal-notify modal-info" role="document">
                                                                    ...
                                                                    <div class="modal-content">
                                                                        {/* <!--Header--> */}
                                                                        <div class="modal-header">
                                                                            <p class="heading lead">List Categories</p>
                                                                        ...
                                                                        <div class="modal-body">
                                                                            <div class="card">
                                                                                ...
                                                                                <div class="card-body text-center px-4 expense-cat" >
                                                                                    <div class="list-group list-group-flush">
                                                                                        ...
                                                                                        <a href="#" class="list-group-item d-flex justify-content-between dark-grey-text"><span className="material-icons">home</span>House</a>
                                                                                        <a href="#" class="list-group-item d-flex justify-content-between dark-grey-text"><span className="material-icons">directions_bus</span>Transportation</a>
                                                                                        <a href="#" class="list-group-item d-flex justify-content-between dark-grey-text"><span className="material-icons">flight_takeoff</span>Travel</a>
                                                                                        <a href="#" class="list-group-item d-flex justify-content-between dark-grey-text"><span className="material-icons">shopping_cart</span>Groceries</a>
                                                                                        <a href="#" class="list-group-item d-flex justify-content-between dark-grey-text"><span className="material-icons">live_tv</span>Entertainment</a>
                                                                                        <a href="#" class="list-group-item d-flex justify-content-between dark-grey-text"><span className="material-icons">sports_handball</span>Sports</a>
                                                                                        <a href="#" class="list-group-item d-flex justify-content-between dark-grey-text"><span className="material-icons">medical_services</span>Medical</a>
                                                                                        <a href="#" class="list-group-item d-flex justify-content-between dark-grey-text"><span className="material-icons">school</span>Education</a>
                                                                                        <a href="#" class="list-group-item d-flex justify-content-between dark-grey-text"><span className="material-icons">shopping_bag</span>Shopping</a>
                                                                                        <a href="#" class="list-group-item d-flex justify-content-between dark-grey-text"><span className="material-icons">offline_bolt</span>Utilities</a>
                                                                                        <a href="#" class="list-group-item d-flex justify-content-between dark-grey-text"><span className="material-icons">loyalty</span>Donations</a>
                                                                                        <a href="#" class="list-group-item d-flex justify-content-between dark-grey-text"><span className="material-icons">subject</span>Other</a>
                                                                                    </div>
                                                                                </div>
                                                                            </div>
                                                                            <hr></hr>
                                                                            <div class="card">
                                                                                ...
                                                                                <div class="card-body text-center px-4 expense-cat" >
                                                                                    <div class="list-group list-group-flush">
                                                                                        ...
                                                                                        <a href="#" class="list-group-item d-flex justify-content-between dark-grey-text"><span className="material-icons">card_giftcard</span>Gift</a>
                                                                                        <a href="#" class="list-group-item d-flex justify-content-between dark-grey-text"><span className="material-icons">business_center</span>Salary</a>
                                                                                        <a href="#" class="list-group-item d-flex justify-content-between dark-grey-text"><span className="material-icons">local_atm</span>Selling</a>
                                                                                        <a href="#" class="list-group-item d-flex justify-content-between dark-grey-text"><span className="material-icons">emoji_symbols</span>Money Interest</a>
                                                                                        <a href="#" class="list-group-item d-flex justify-content-between dark-grey-text"><span className="material-icons">subject</span>Other</a>
                                                                        ...
                                                                        <div class="modal-footer justify-content-center">
                                                                            <a type="button" class="btn btn-outline-primary waves-effect" data-dismiss="modal">Get it</a>
                                                                        </div>
                                                                    </div>
                                                                    {/* <!--/.Content--> */}
                                                                </div>
                                                            ...
                                                            {/* <!-- Central Modal Medium Info--> */}
                                                            <hr class="w-header my-4" />
                                                            <p class="lead text-center text-muted pt-2 mb-5">Now your file is ready to be imported</p>
                                                        </div>
                                ...
                                {/* <!-- Central Modal Medium Info--> */}
                                {/* end modal */}
                                <h3 class="font-weight-bold my-3">Import your training data file</h3>

                                <p class="text-muted mb-4 pb-2">This app can learn more to support you in categorizing your transactions </p>
                                <small class="form-text black-text"><strong>* Just accept .csv file</strong></small>
                                <div className="input-group">
                                    <input type="file" class="form-control" name="file" onChange={handleChange} required />
                                    <div class="input-group-append">
                                        <button class="btn btn-md btn-primary rounded-right m-0 px-3 py-2 z-depth-0 waves-effect" type="submit" id="button-addon2">Import</button>
                                    </div>
                                </div>
