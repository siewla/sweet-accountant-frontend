                                        ...
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                ...
                                                <section>
                                                    ...
                                                    <h3 class="font-weight-bold text-center dark-grey-text pb-2">Four Easy Steps</h3>
                                                    ...
                                                    <div class="row align-items-center">
                                                        ...
                                                        <div class="">
                                                            <div class="view z-depth-1-half rounded">
                                                                <img class="rounded img-fluid" src="https://res.cloudinary.com/dt5rqi1l9/image/upload/v1599625363/Screen_Shot_2020-09-09_at_12.22.19_PM_l53yvc.png" alt="Video title" />
                                                            ...
                                                            <ol class="step pl-0">
                                                                <li class="step-element pb-0">
                                                                    ...
                                                                    <div class="step-excerpt">
                                                                        <h6 class="font-weight-bold dark-grey-text mb-3">Download your Bank statement in csv file</h6>
                                                                        <p class="text-muted">If you have your own excel file recording all your transactions, edit it (step 3) and export to csv file</p>
                                                                    </div>
                                                                </li>
                                                                <li class="step-element pb-0">
                                                                    <div class="step-number">
                                                                    ...
                                                                    <div class="step-excerpt">
                                                                        <h6 class="font-weight-bold dark-grey-text mb-3">Open </h6>
                                                                        <p class="text-muted">Open with Numbers/ Excel/ Google Sheet</p>
                                                                    </div>
                                                                </li>
                                                                <li class="step-element pb-0">
                                                                    <div class="step-number">
                                                                    ...
                                                                    <div class="step-excerpt">
                                                                        <h6 class="font-weight-bold dark-grey-text mb-3">Edit</h6>
                                                                        <p class="text-muted"> Make sure your data has 3 columns (date, description, amount) in a correct order</p>
                                                                    </div>
                                                                </li>
                                                                <li class="step-element pb-0">
                                                                    <div class="step-number">
