...
const Categories = () => {
    return (
        <div>
            <h3><span class="material-icons">fastfood</span>Food & Drink</h3>
            <h3><span class="material-icons">home</span>House</h3>
            <h3><span class="material-icons">directions_bus</span>Transportation</h3>
            <h3><span class="material-icons">flight_takeoff</span>Travel</h3>
            ...
            <h3><span class="material-icons">offline_bolt</span>Utilities</h3>
            <h3><span class="material-icons">loyalty</span>Donations</h3>
        </div>
    )
}
