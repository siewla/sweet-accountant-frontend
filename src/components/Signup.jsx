              ...
              <form>
                ...
                <div className="card-body">
                  ...
                  <div className="md-form">
                    ...
                    <input type="text" id="form3" className="white-text form-control" autoComplete="username" />
                    <label htmlFor="form3" className="active">Your name</label>
                  </div>

                  <div className="md-form">
                    <i className="fas fa-envelope prefix white-text active"></i>
                    <input type="email" id="form2" className="white-text form-control" autoComplete="username" />
                    <label htmlFor="form2" className="active">Your email</label>
                  </div>

                  <div className="md-form">
                    <i className="fas fa-lock prefix white-text active"></i>
                    <input type="password" id="form4" className="white-text form-control" autoComplete="new-password"/>
